          ...
          <Popover
            ...
            renderPopover={
              <div className='relative rounded-sm border border-gray-200 bg-white shadow-md'>
                ...
                <button className='text-left w-full block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500'>
                  Đăng xuất
                </button>
              </div>
            }
                ...
                <div className='bg-white relative shadow-md rounded-sm border border-gray-200 max-w-[400px] text-sm'>
                  <div className='p-2'>
                      ...
                      <div className='mt-4 flex'>
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            [LIFECMBP2 - 12% đơn 250k] Bộ nồi Inox 3 Đáy SUNHOUSE SH334 16, 20, 24 cm
                          </div>
                        </div>
                    ...
                    <div className='flex mt-6 items-center justify-between'>
                      ...
                      <button className='captialize bg-orange hover:bg-opacity-90 px-4 py-2 rounded-sm text-white'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
