          ...
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center'>
                ...
                <button className='ml-4 flex h-12 min-w-[5rem] items-center justify-center rounded-sm bg-orange px-5 capitalize text-white shadow-sm hover:bg-orange/90 outline-none'>
                  Mua ngay
                </button>
              </div>
            </div>
