      ...
      <div className='bg-white shadow rounded-sm overflow-hidden hover:translate-y-[-0.04rem] hover:shadow-md duration-100 transition-transform'>
        <div className='w-full pt-[100%] relative'>
          <img
            ...
            alt=''
            className='absolute top-0 left-0 h-full w-full object-cover bg-white'
          />
        </div>
        <div className='p-2 overflow-hidden'>
          <div className='min-h-[2rem] line-clamp-2 text-xs'>
            [HÀNG HIỆU] Thắt Lưng Da Nam Khoá Tự Động Cao Cấp Dây Nịt Nam Mặt Xoay Chính Hãng, Phong Cách Hàn Quốc -
            v77men
          </div>
